...
class CustomUser(AbstractUser):
    ...
    phone_number = models.CharField(
        max_length=46, blank=True, null=True, verbose_name="Номер телефона"
    )
...
class Payment(models.Model):
    ...
    price_id = models.CharField(
        max_length=255, blank=True, null=True, verbose_name="ID цены"
    )
    product_id = models.CharField(
        max_length=255, blank=True, null=True, verbose_name="ID продукта"
    )
